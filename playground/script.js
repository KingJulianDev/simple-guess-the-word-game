const keyboardRus = [1081, 1094, 1091, 1082, 1077, 1085, 1075, 1096, 1097, 1079, 1093, 1098, 1092, 1099, 1074, 1072, 1087, 
    1088, 1086, 1083, 1076, 1078, 1101, 1103, 1095, 1089, 1084, 1080, 1090, 1100, 1073, 1102];

const keyboardEng = [113, 119, 101, 114, 116, 121, 117, 105, 111, 112, 97, 115, 100, 102, 103, 104, 106, 107, 108, 122, 
    120, 99, 118, 98, 110, 109]

const arraysRus = [

    animals = ['лев', 'зебра', 'коала', 'панда', 'змея', 'носорог', 'слон', 'антилопа', 'гиена', 'жираф', 'сурикат', 
'кабан', 'тигр', 'бегемот', 'лемур', 'волк', 'овца', 'крокодил', 'хомяк', 'хамелеон', 'буйвол', 'лошадь', 'олень', 
'ягуар', 'зубр', 'медведь', 'кенгуру', 'ленивец', 'гепард', 'рысь', 'бизон', 'горилла', 'баран', 'верблюд', 'муравьед', 
'кашелот', 'выдра', 'корова', 'лисица', 'крыса', 'бобер', 'собака', 'кошка', 'бабак'],
    geography = ['Австрия', 'Вена', 'Албания', 'Тирана', 'Белоруссия', 'Минск', 'Бельгия', 'Брюссель',
'Болгария', 'София', 'Великобритания', 'Лондон', 'Венгрия', 'Будапешт', 'Германия', 'Берлин', 'Греция', 'Афины', 'Дания',
'Копенгаген', 'Исландия', 'Рейкьявик', 'Испания', 'Мадрид', 'Италия', 'Рим', 'Латвия', 'Рига', 'Литва', 'Вильнюс',
'Лихтенштейн', 'Вадуц', 'Люксембург', 'Македония', 'Скопье', 'Мальта', 'Валлетта', 'Молдавия', 'Кишинев', 'Монако', 'Осло',
'Нидерланды', 'Амстердам', 'Норвегия', 'Польша', 'Мадрид', 'Варшава', 'Португалия', 'Лиссабон', 'Россия', 'Москва',
'Румыния', 'Бухарест', 'Сербия', 'Белград', 'Словакия', 'Братислава', 'Словения', 'Любляна', 'Украина', 'Киев', 'Финляндия',
'Хельсинки', 'Франция', 'Париж', 'Хорватия', 'Загреб', 'Черногория', 'Подгорица', 'Чехия', 'Прага', 'Швейцария', 'Берн',
'Швеция', 'Стокгольм', 'Эстония', 'Таллин', 'Ирландия', 'Дублин', 'Рим', 'Латвия', 'Рига', 'Литва', 'Вильнюс'],
    football = ['Милан', 'Сассуоло', 'Интер', 'Наполи', 'Аталанта', 'Сампдория', 'Ювентус', 'Верона', 'Рома', 'Кальяри',
'Лацио','Специя', 'Фиорентина', 'Дженоа', 'Парма', 'Удинезе', 'Болонья', 'Торино', 'Кротоне', 'Эмполи', 'Лейпциг',
'Бавария', 'Боруссия', 'Штутгарт', 'Айнтрахт', 'Аугсбург', 'Вердер', 'Хоффенхайм', 'Унион', 'Байер', 'Фрайбург',
'Вольфсбург', 'Арминия', 'Герта', 'Кельн', 'Шальке', 'Майнц',],
    cars = ['акура', 'ауди', 'бентли', 'бугатти', 'кадиллак', 'чери', 'шевроле', 'крайслер', 'ситроен', 'дачия', 'вольво',
'додж', 'феррари', 'фиат', 'форд', 'джили', 'генезис', 'хонда', 'хаммер', 'хюндай', 'инфинити', 'ивеко', 'ягуар',
'ламборджини', 'лянча', 'лексус', 'линкольн', 'мазерати', 'мазда', 'митсубиси', 'ниссан', 'опель', 'пежо', 'понтиак', 
'порше', 'равон', 'рено', 'ровер', 'скания', 'сеат', 'шкода', 'смарт', 'субару', 'сузуки', 'тесла', 'тойота', 'фольксваген'],
    profession = ['авиадеспетчер', 'авиаинженер', 'автомеханик', 'автослесарь', 'агроном', 'адвокат', 'администратор', 'актер',
'актуарий', 'аналитик', 'аниматор', 'архивариус', 'архитектор', 'астроном', 'аудитор', 'банкир', 'бармен', 'биоинженер',
'биолог', 'биотехнолог', 'блогер', 'брокер', 'бухгалтер', 'ветеринар', 'визажист', 'врач', 'геолог', 'геофизик', 'гид', 'дегустатор', 
'дизайнер', 'дипломат', 'директор', 'журналист', 'инженер', 'картограф', 'кинолог', 'кинооператор', 'кондитер', 'корректор', 'косметолог',
'криминалист', 'критик', 'лингист', 'логист', 'логопед', 'маркетолог', 'масажист', 'менеджер', 'медсестра', 'мерчендайзер', 'модельер',
'нотариус', 'ортопед', 'официант', 'парикхмахер', 'педагог', 'переводчик', 'пилот', 'писатель', 'повар', 'пожарный', 'политолог',
'полицейский', 'программист', 'продавец', 'прокурор', 'прораб', 'психолог', 'редактор', 'режиссер', 'ресторатор', 'риелтор', 'сварщик',
'секретарь', 'следователь', 'социолог', 'стилист', 'стоматолог', 'стюардесса', 'судья', 'сценарист', 'телеведущий', 'технолог', 'товаровед',
'трейдер', 'тренер', 'учитель', 'фармацевт', 'флорист', 'фотограф', 'хореограф', 'экономист', 'энергетик', 'этнограф', 'ювелир', 'хирург',
'юрист',]
]

const arraysEng = [
    animals = ['lion', 'zebra', 'koala', 'panda', 'snake', 'rhinoceros', 'elephant', 'antelope', 'hyena', 'giraffe', 'meerkat',
'boar', 'tiger', 'hippo', 'lemur', 'wolf', 'sheep', 'crocodile', 'hamster', 'chameleon', 'buffalo', 'horse', 'deer',
'jaguar', 'bison', 'bear', 'kangaroo', 'sloth', 'cheetah', 'lynx', 'bison', 'gorilla', 'ram', 'camel', 'anteater',
'kashelot', 'otter', 'cow', 'fox', 'rat', 'beaver', 'dog', 'cat', 'babak',],
    geography = ['Austria', 'Vienna', 'Albania', 'Tirana', 'Belarus', 'Minsk', 'Belgium', 'Brussels',
'Bulgaria', 'Sofia', 'London', 'Hungary', 'Budapest', 'Germany', 'Berlin', 'Greece', 'Athens', 'Denmark',
'Copenhagen', 'Iceland', 'Reykjavik', 'Spain', 'Madrid', 'Italy', 'Rome', 'Latvia', 'Riga', 'Lithuania', 'Vilnius',
'Liechtenstein', 'Vaduz', 'Luxembourg', 'Macedonia', 'Skopje', 'Malta', 'Valletta', 'Moldova', 'Chisinau', 'Monaco', 'Oslo',
'Netherlands', 'Amsterdam', 'Norway', 'Poland', 'Madrid', 'Warsaw', 'Portugal', 'Lisbon', 'Russia', 'Moscow',
'Romania', 'Bucharest', 'Serbia', 'Belgrade', 'Slovakia', 'Bratislava', 'Slovenia', 'Ljubljana', 'Ukraine', 'Kiev', 'Finland',
'Helsinki', 'France', 'Paris', 'Croatia', 'Zagreb', 'Montenegro', 'Podgorica', 'Prague', 'Switzerland', 'Bern',
'Sweden', 'Stockholm', 'Estonia', 'Tallinn', 'Ireland', 'Dublin', 'Rome', 'Latvia', 'Riga', 'Lithuania', 'Vilnius',],
    football = ['Milan', 'Sassuolo', 'Inter', 'Napoli', 'Atalanta', 'Sampdoria', 'Juventus', 'Verona', 'Roma', 'Cagliari',
'Lazio', 'Spice', 'Fiorentina', 'Genoa', 'Parma', 'Udinese', 'Bologna', 'Torino', 'Crotone', 'Empoli', 'Leipzig',
'Bavaria', 'Borussia', 'Stuttgart', 'Eintracht', 'Augsburg', 'Werder', 'Hoffenheim', 'Union', 'Bayer', 'Freiburg',
'Wolfsburg', 'Arminia', 'Hertha', 'Cologne', 'Schalke', 'Mainz',],
    cars = ['acura', 'audi', 'bugatti', 'buick', 'cadillac', 'chery', 'citroen', 'dacia', 'daewoo', 'ferrari',
'fiat', 'genesis', 'honda', 'hummer', 'isuzu', 'iveco', 'jaguar', 'jeep', 'lamborghini', 'lancia', 'lexus',
'maserati', 'mazda', 'mercury', 'mitsubishi', 'nissan', 'opel', 'peugeot', 'porsche', 'proton', 'ravon', 'renault', 
'rover', 'saab', 'saturn', 'scania', 'skoda', 'smart', 'ssangyong', 'tesla', 'toyota', 'bentley', 'chevrolet',
'chrysler', 'datsun', 'dodge', 'ford', 'geely', 'hyndai', 'infiniti', 'koenigsegg', 'lincoln', 'lotus', 'mini', 
'piaggio', 'pontiac', 'roewe', 'scion', 'seat', 'subaru', 'suzuki', 'volkswagen', 'volvo',],
]
...
let quantityOfAttempts = parseInt(document.querySelector('.attempts-content').textContent.match(/\d{1,}/))
...
leftArrAtt.onclick = () => {
    quantityOfAttempts --
    checkArrowStatus()
    document.querySelector('.attempts-content').textContent = `Attempts: ${quantityOfAttempts}`
...
start.onclick = function(){
    ...
    (indexOfLanguages === 0) ? renderingKeyboard(keyboardEng) : renderingKeyboard(keyboardRus);
    ...
    homeButton.onclick = () => {
        ...
        attemptsLeft = quantityOfAttempts
        document.querySelector('.attempts-content').textContent = `Attempts: ${attemptsLeft}`
        quessedLetters = []
        isRandomMode = false
        checkOptionStatus(isRandomMode, randomModeButton)
...
function gameLoop(){
    ...
    if(isRandomMode === false){
        (indexOfLanguages === 0) ? randomWord(arraysEng[indexOfCategorie]) : randomWord(arraysRus[indexOfCategorie]);
...
function indexOfLetter(){
    for(let i=0; i < word.length; i++){
        if(word[i].toLowerCase() == enteredLetter){
            ...
            document.querySelectorAll('.hiddenLetter')[i].innerText = enteredLetter.toUpperCase()
...
function renderingKeyboard(keyboardLang){ 
    ...
    for(let i = 0; i < keyboardLang.length; i++){
        if(indexOfLanguages === 1 && i < 12 || indexOfLanguages === 0 && i < 10){
            out += '<div class = "key">' + String.fromCharCode(keyboardLang[i]).toUpperCase() + '</div>'
            document.querySelector('.f-row').innerHTML = out
        }else if(indexOfLanguages === 1 && i === 12 || indexOfLanguages === 0 && i === 10){
            out = '<div class = "clear-fix key">' + String.fromCharCode(keyboardLang[i]).toUpperCase() + '</div>'
            document.querySelector('.s-row').innerText = out
        }else if(indexOfLanguages === 1 && i < 23 || indexOfLanguages === 0 && i < 19){
            out += '<div class = "key">' + String.fromCharCode(keyboardLang[i]).toUpperCase() + '</div>'
            document.querySelector('.s-row').innerHTML = out
        }else if(indexOfLanguages === 1 && i === 23 || indexOfLanguages === 0 && i === 19){
            out = '<div class = "clear-fix key">' + String.fromCharCode(keyboardLang[i]).toUpperCase() + '</div>'//IMG
            document.querySelector('.t-row').innerHTML = out
        }else if(indexOfLanguages === 1 && i < 33 || indexOfLanguages === 0 && i < 26){
            out += '<div class = "key">' + String.fromCharCode(keyboardLang[i]).toUpperCase() + '</div>'
            document.querySelector('.t-row').innerHTML = out
        }
    } 
...
function targetHintActivate(){
    ...
    letters.forEach((el) => {
        el.onclick = () => {
            let targetHintedLetter= word[arrayFromHiddenLetters.indexOf(el)].toUpperCase()
            quessedLetters.push(targetHintedLetter)
            for(let i = 0; i < word.length; i++){
                if(word[i].toUpperCase() == targetHintedLetter){
                    arrayFromHiddenLetters[i].textContent = targetHintedLetter.toUpperCase()
                    remainingLetters--
                    if(remainingLetters == 0){
                        alert('Ты победил!')
                    }
...
function hintedLetterF(hintedLetter){
    ...
    for(let i = 0; i < word.length; i++){
        if(hintedLetter === word[i].toUpperCase()){
            remainingLetters--
            if(remainingLetters == 0){alert('Ты победил!')}
...
categoriesSelector.forEach((el) => {
    ...
    el.onclick = () => {
        ...
        (isCategorieActive == true) ? el.classList.add('li-active') : el.classList.remove('li-active');
        
        if(categoriesForRandomMode.includes(categories[categoriesSelector.indexOf(el)])){
            categoriesForRandomMode.splice(categoriesForRandomMode.indexOf(categories[categoriesSelector.indexOf(el)]), 1)
        }else{
